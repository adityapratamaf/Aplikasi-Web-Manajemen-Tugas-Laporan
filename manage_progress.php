				...
				<div class="col-md-5">
					...
					<div class="form-group">
						...
						<select name="subject" id="subject" class="custom-select custom-select-sm">
							<option value="3" <?php echo isset($subject) && $subject == 3 ? 'selected' : '' ?>>Sesuai Rencana</option>
							<option value="4" <?php echo isset($subject) && $subject == 4 ? 'selected' : '' ?>>Tidak Sesuai Rencana</option>
						</select>
					</div>
					...
					<div class="form-group">
						...
						<input type="date" class="form-control form-control-sm" name="date_end" value="<?php echo isset($date_end) ? date("Y-m-d", strtotime($date_end)) : '' ?>" required>
					</div>
