	...
	<form action="" id="manage-task">
		...
		<div class="form-group">
			...
			<select name="status" id="status" class="custom-select custom-select-sm">
				<option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>Tunda</option>
				<option value="2" <?php echo isset($status) && $status == 2 ? 'selected' : '' ?>>Proses</option>
				<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>Selesai</option>
				<option value="4" <?php echo isset($status) && $status == 4 ? 'selected' : '' ?>>Gagal</option>
			</select>
		</div>
