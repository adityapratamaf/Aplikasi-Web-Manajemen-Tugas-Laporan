                        ...
                        <a class="btn btn-primary btn-sm" href="./index.php?page=view_project&id=<?php echo $row['id'] ?>">
							...
							<td class="text-center">
								...
								<div class="dropdown-menu" style="">
									<a class="dropdown-item view_project" href="./index.php?page=view_project&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">Lihat</a>
									<div class="dropdown-divider"></div>
									<?php if ($_SESSION['login_type'] != 3) : ?>
										<a class="dropdown-item" href="./index.php?page=edit_project&id=<?php echo $row['id'] ?>">Edit</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item delete_project" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Hapus</a>
									<?php endif; ?>
								</div>
							</td>
						</tr>
...
<script>
	$(document).ready(function() {
		...
		$('.delete_project').click(function() {
			_conf("Hapus Data ?", "delete_project", [$(this).attr('data-id')])
		})
	})
