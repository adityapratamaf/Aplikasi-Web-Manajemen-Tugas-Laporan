...
<div class="col-12">
  <div class="card">
    <div class="card-header">
      <b>Selamat Datang <?php echo $_SESSION['login_name'] ?> !</b>
    </div>
  </div>
</div>
<hr>
  ...
  <div class="col-md-4">
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-md-12">
        <div class="small-box bg-light shadow-sm border">
          <div class="inner">
            <h3><?php echo $conn->query("SELECT t.*,p.name as pname,p.start_date,p.status as pstatus, p.end_date,p.id as pid FROM user_productivity t inner join project_list p on p.id = t.project_id $where2")->num_rows; ?></h3>
            <p>Total Laporan</p>
          </div>
          <div class="icon">
